...
Detail process please check: [`03.NHPABC_CellChat_ARLR_truncatedMean.ipynb`](https://github.com/3DC-STAR-Anthony/NHPABC/blob/main/snRNA/05.Cell-cell_interaction/03.NHPABC_CellChat_ARLR_truncatedMean.ipynb)
# Dependencies
